...
| 函数 | 描述 | 参数 | 返回值 | 复杂度 |
|------|------|------|--------|--------|
| `push_back()` | 添加元素到末尾 | 要添加的值 | void | 均摊O(1) |
| `pop_back()` | 移除末尾元素 | 无 | void | O(1) |
| `size()` | 获取元素个数 | 无 | size_t类型的元素个数 | O(1) |
| `empty()` | 检查是否为空 | 无 | 布尔值 | O(1) |
| `at(pos)` | 访问指定位置元素(带边界检查) | 索引位置 | 元素引用 | O(1) |
| `operator[]` | 访问指定位置元素(不检查边界) | 索引位置 | 元素引用 | O(1) |
| `clear()` | 清空所有元素 | 无 | void | O(n) |
| `insert()` | 在指定位置插入元素 | 迭代器位置,要插入的值 | 指向插入元素的迭代器 | O(n) |
| `erase()` | 删除指定位置的元素 | 迭代器位置 | 指向下一个元素的迭代器 | O(n) |
| `emplace_back()` | 在末尾原位构造元素 | 构造参数 | C++11起:元素引用 | 均摊O(1) |
| `reserve()` | 预留容量空间不创建元素 | 容量大小 | void | 最坏O(n) |
| `resize()` | 调整容器大小 | 新大小,[可选]默认值 | void | 最坏O(n) |
| `capacity()` | 返回当前分配的容量 | 无 | size_t类型的容量 | O(1) |
| `front()` | 返回首元素的引用 | 无 | 首元素引用 | O(1) |
| `back()` | 返回末元素的引用 | 无 | 末元素引用 | O(1) |
| `data()` | 返回指向数据的指针 | 无 | 指向数据的指针 | O(1) |
| `shrink_to_fit()` | 减少内存到适合大小 | 无 | void | O(n) |
| `assign()` | 替换容器内容 | 各种输入源 | void | O(n) |
| `swap()` | 与另一容器交换内容 | 另一个vector | void | O(1) |
...
| 函数 | 描述 | 参数 | 返回值 | 复杂度 |
|------|------|------|--------|--------|
| `push_front()` | 在前端添加元素 | 要添加的值 | void | O(1) |
| `push_back()` | 在末尾添加元素 | 要添加的值 | void | O(1) |
| `pop_front()` | 移除前端元素 | 无 | void | O(1) |
| `pop_back()` | 移除末尾元素 | 无 | void | O(1) |
| `size()` | 获取元素个数 | 无 | size_t类型的元素个数 | O(1) |
| `empty()` | 检查是否为空 | 无 | 布尔值 | O(1) |
| `at(pos)` | 访问指定位置元素(带边界检查) | 索引位置 | 元素引用 | O(1) |
...
| `insert()` | 在指定位置插入元素 | 迭代器位置,要插入的值 | 指向插入元素的迭代器 | O(n) |
| `erase()` | 删除指定位置的元素 | 迭代器位置 | 指向下一个元素的迭代器 | O(n) |
| `emplace_front()` | 在前端原位构造元素 | 构造参数 | C++11起:元素引用 | O(1) |
| `emplace_back()` | 在末尾原位构造元素 | 构造参数 | C++11起:元素引用 | O(1) |
| `resize()` | 调整容器大小 | 新大小,[可选]默认值 | void | 最坏O(n) |
| `front()` | 返回首元素的引用 | 无 | 首元素引用 | O(1) |
| `back()` | 返回末元素的引用 | 无 | 末元素引用 | O(1) |
| `shrink_to_fit()` | 减少内存到适合大小 | 无 | void | O(n) |
| `assign()` | 替换容器内容 | 各种输入源 | void | O(n) |
| `swap()` | 与另一容器交换内容 | 另一个deque | void | O(1) |
...
| `empty()` | 检查是否为空 | 无 | 布尔值 | O(1) |
| `clear()` | 清空所有元素 | 无 | void | O(n) |
| `insert()` | 在指定位置插入元素 | 迭代器位置,要插入的值 | 指向插入元素的迭代器 | O(1) |
| `erase()` | 删除指定位置的元素 | 迭代器位置 | 指向下一个元素的迭代器 | O(1) |
| `emplace_front()` | 在前端原位构造元素 | 构造参数 | C++11起:元素引用 | O(1) |
| `emplace_back()` | 在末尾原位构造元素 | 构造参数 | C++11起:元素引用 | O(1) |
| `resize()` | 调整容器大小 | 新大小,[可选]默认值 | void | 最坏O(n) |
| `front()` | 返回首元素的引用 | 无 | 首元素引用 | O(1) |
| `back()` | 返回末元素的引用 | 无 | 末元素引用 | O(1) |
| `assign()` | 替换容器内容 | 各种输入源 | void | O(n) |
| `swap()` | 与另一容器交换内容 | 另一个list | void | O(1) |
| `splice()` | 将其他列表的元素移动到此列表 | 迭代器位置,另一个list | void | O(1) |
| `merge()` | 合并另一个有序链表 | 另一个list | void | O(n) |
| `unique()` | 移除相邻重复元素 | 无 | void | O(n) |
| `sort()` | 对链表排序 | 无 | void | O(n log n) |
| `reverse()` | 反转链表 | 无 | void | O(n) |
...
| 函数 | 描述 | 参数 | 返回值 | 复杂度 |
|------|------|------|--------|--------|
| `insert()` | 插入元素 | 要插入的值 | pair<迭代器,bool> | O(log n) |
| `erase()` | 删除指定元素 | 要删除的值 | size_t类型的删除个数 | O(log n) |
| `find()` | 查找元素 | 要查找的值 | 迭代器 | O(log n) |
| `count()` | 计算元素出现次数 | 要计算的值 | size_t类型的次数 | O(log n) |
| `size()` | 获取元素个数 | 无 | size_t类型的元素个数 | O(1) |
| `empty()` | 检查是否为空 | 无 | 布尔值 | O(1) |
| `clear()` | 清空所有元素 | 无 | void | O(n) |
| `emplace()` | 原位插入元素 | 构造参数 | pair<迭代器,bool> | O(log n) |
| `lower_bound()` | 返回第一个不小于key的迭代器 | key | 迭代器 | O(log n) |
| `upper_bound()` | 返回第一个大于key的迭代器 | key | 迭代器 | O(log n) |
| `equal_range()` | 返回等于key的范围 | key | pair<迭代器,迭代器> | O(log n) |
| `swap()` | 与另一容器交换内容 | 另一个set | void | O(1) |
...
| 函数 | 描述 | 参数 | 返回值 | 复杂度 |
|------|------|------|--------|--------|
| `insert()` | 插入键值对 | 要插入的键值对 | pair<迭代器,bool> | O(log n) |
| `erase()` | 删除指定键的元素 | 要删除的键 | size_t类型的删除个数 | O(log n) |
| `find()` | 查找键对应的元素 | 要查找的键 | 迭代器 | O(log n) |
| `count()` | 计算键出现次数 | 要计算的键 | size_t类型的次数 | O(log n) |
| `size()` | 获取元素个数 | 无 | size_t类型的元素个数 | O(1) |
| `empty()` | 检查是否为空 | 无 | 布尔值 | O(1) |
| `clear()` | 清空所有元素 | 无 | void | O(n) |
| `operator[]` | 访问或插入键对应的值 | 要访问的键 | 值的引用 | O(log n) |
| `emplace()` | 原位插入键值对 | 构造参数 | pair<迭代器,bool> | O(log n) |
| `lower_bound()` | 返回第一个不小于key的迭代器 | key | 迭代器 | O(log n) |
| `upper_bound()` | 返回第一个大于key的迭代器 | key | 迭代器 | O(log n) |
| `equal_range()` | 返回等于key的范围 | key | pair<迭代器,迭代器> | O(log n) |
| `swap()` | 与另一容器交换内容 | 另一个map | void | O(1) |
...
| 函数 | 描述 | 参数 | 返回值 | 复杂度 |
|------|------|------|--------|--------|
| `insert()` | 插入元素 | 要插入的值 | pair<迭代器,bool> | 平均O(1) |
| `erase()` | 删除指定元素 | 要删除的值 | size_t类型的删除个数 | 平均O(1) |
| `find()` | 查找元素 | 要查找的值 | 迭代器 | 平均O(1) |
| `count()` | 计算元素出现次数 | 要计算的值 | size_t类型的次数 | 平均O(1) |
| `size()` | 获取元素个数 | 无 | size_t类型的元素个数 | O(1) |
| `empty()` | 检查是否为空 | 无 | 布尔值 | O(1) |
| `clear()` | 清空所有元素 | 无 | void | O(n) |
| `emplace()` | 原位插入元素 | 构造参数 | pair<迭代器,bool> | 平均O(1) |
| `bucket_count()` | 返回当前哈希桶的数量 | 无 | size_t类型的桶数 | O(1) |
| `load_factor()` | 返回当前负载因子 | 无 | float类型的负载因子 | O(1) |
| `rehash()` | 重新配置哈希桶数量 | 新桶数 | void | O(n) |
| `swap()` | 与另一容器交换内容 | 另一个unordered_set | void | O(1) |
...
| 函数 | 描述 | 参数 | 返回值 | 复杂度 |
|------|------|------|--------|--------|
| `insert()` | 插入键值对 | 要插入的键值对 | pair<迭代器,bool> | 平均O(1) |
| `erase()` | 删除指定键的元素 | 要删除的键 | size_t类型的删除个数 | 平均O(1) |
| `find()` | 查找键对应的元素 | 要查找的键 | 迭代器 | 平均O(1) |
| `count()` | 计算键出现次数 | 要计算的键 | size_t类型的次数 | 平均O(1) |
| `size()` | 获取元素个数 | 无 | size_t类型的元素个数 | O(1) |
| `empty()` | 检查是否为空 | 无 | 布尔值 | O(1) |
| `clear()` | 清空所有元素 | 无 | void | O(n) |
| `operator[]` | 访问或插入键对应的值 | 要访问的键 | 值的引用 | 平均O(1) |
| `emplace()` | 原位插入键值对 | 构造参数 | pair<迭代器,bool> | 平均O(1) |
| `bucket_count()` | 返回当前哈希桶的数量 | 无 | size_t类型的桶数 | O(1) |
| `load_factor()` | 返回当前负载因子 | 无 | float类型的负载因子 | O(1) |
| `rehash()` | 重新配置哈希桶数量 | 新桶数 | void | O(n) |
| `swap()` | 与另一容器交换内容 | 另一个unordered_map | void | O(1) |
...
| 函数 | 描述 | 参数 | 返回值 | 复杂度 |
|------|------|------|--------|--------|
| `push()` | 添加元素到队列末尾 | 要添加的值 | void | O(1) |
| `pop()` | 移除队列前端元素 | 无 | void | O(1) |
| `front()` | 访问队列前端元素 | 无 | 元素引用 | O(1) |
| `back()` | 访问队列末尾元素 | 无 | 元素引用 | O(1) |
| `empty()` | 检查是否为空 | 无 | 布尔值 | O(1) |
| `size()` | 获取元素个数 | 无 | size_t类型的元素个数 | O(1) |
| `emplace()` | 原位添加元素到队列末尾 | 构造参数 | void | O(1) |
| `swap()` | 与另一容器交换内容 | 另一个queue | void | O(1) |
...
| 函数 | 描述 | 参数 | 返回值 | 复杂度 |
|------|------|------|--------|--------|
| `push()` | 添加元素 | 要添加的值 | void | O(log n) |
| `pop()` | 移除优先级最高的元素 | 无 | void | O(log n) |
| `top()` | 访问优先级最高的元素 | 无 | 元素引用 | O(1) |
| `empty()` | 检查是否为空 | 无 | 布尔值 | O(1) |
| `size()` | 获取元素个数 | 无 | size_t类型的元素个数 | O(1) |
| `emplace()` | 原位添加元素 | 构造参数 | void | O(log n) |
| `swap()` | 与另一容器交换内容 | 另一个priority_queue | void | O(1) |
...
| 函数 | 描述 | 参数 | 返回值 | 复杂度 |
|------|------|------|--------|--------|
| `push()` | 添加元素到栈顶 | 要添加的值 | void | O(1) |
| `pop()` | 移除栈顶元素 | 无 | void | O(1) |
| `top()` | 访问栈顶元素 | 无 | 元素引用 | O(1) |
| `empty()` | 检查是否为空 | 无 | 布尔值 | O(1) |
| `size()` | 获取元素个数 | 无 | size_t类型的元素个数 | O(1) |
| `emplace()` | 原位添加元素到栈顶 | 构造参数 | void | O(1) |
| `swap()` | 与另一容器交换内容 | 另一个stack | void | O(1) |
...
| 函数 | 描述 | 参数 | 返回值 | 复杂度 |
|------|------|------|--------|--------|
| `set()` | 将所有位或指定位置的位设置为1 | [可选]位置 | void | O(1) |
| `reset()` | 将所有位或指定位置的位重置为0 | [可选]位置 | void | O(1) |
| `flip()` | 将所有位或指定位置的位取反 | [可选]位置 | void | O(1) |
| `test()` | 检查指定位置的位是否为1 | 位置 | 布尔值 | O(1) |
| `all()` | 检查所有位是否都为1 | 无 | 布尔值 | O(1) |
| `any()` | 检查是否存在为1的位 | 无 | 布尔值 | O(1) |
| `none()` | 检查是否所有位都为0 | 无 | 布尔值 | O(1) |
| `count()` | 返回为1的位的个数 | 无 | size_t类型的个数 | O(1) |
| `size()` | 返回位的总数 | 无 | size_t类型的总数 | O(1) |
| `to_string()` | 返回位的字符串表示 | 无 | std::string | O(n) |
| `to_ulong()` | 返回位的无符号长整型表示 | 无 | unsigned long | O(1) |
| `to_ullong()` | 返回位的无符号长长整型表示 | 无 | unsigned long long | O(1) |

### 构造和初始化

```cpp
// 构造和初始化
std::bitset<8> bs1; // 默认构造
...
size_t count = bs1.count(); // 返回为1的位的个数
size_t size = bs1.size(); // 返回位的总数
```
